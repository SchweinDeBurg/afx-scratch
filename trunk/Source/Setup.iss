...
[Setup]
AppName=AfxScratch
AppVerName=AfxScratch 1.1.5673
...
OutputDir=..\Setup
OutputBaseFilename=AfxScratch-1.1.5673-setup
VersionInfoVersion=1.1.5673.192
...
Source: "..\Output.2008\x86\Release\Unicode\AfxScratch.exe"; DestDir: "{app}"
