...
OutputDir=..\Setup
OutputBaseFilename=AfxScratch-@VER_MAJOR@.@VER_MINOR@.@VER_BUILD@-setup-universal
...
Source: "..\Output.2008\x86\@BUILD_TYPE@\@CHARACTER_SET@\AfxScratch.exe"; Components: core; DestDir: "{app}"
